...
# Configuration — update after publishing to Tableau Public
TABLEAU_DASHBOARD_URL = os.getenv(
    'TABLEAU_DASHBOARD_URL',
    'https://prod-in-a.online.tableau.com/t/prasannaprasanna14200-0e9eb2418d/views/Book4/Dashboard3?:showVizHome=no&:embed=true'
)
TABLEAU_STORY_URL = os.getenv(
    'TABLEAU_STORY_URL',
    'https://prod-in-a.online.tableau.com/t/prasannaprasanna14200-0e9eb2418d/views/Book4/Story1?:showVizHome=no&:embed=true'
)
